...
| event.path | see ^path of [Layer 3](http://axkibe.github.io/lsyncd/manual/config/layer3/#all-possible-variables) |
| event.pathname | see ^pathname of [Layer 3](http://axkibe.github.io/lsyncd/manual/config/layer3/#all-possible-variables) |
| event.source | see ^source of [Layer 3](http://axkibe.github.io/lsyncd/manual/config/layer3/#all-possible-variables) |
| event.sourcePath | see ^sourcePath of [Layer 3](http://axkibe.github.io/lsyncd/manual/config/layer3/#all-possible-variables) |
| event.sourcePathname | see ^sourcePathname of [Layer 3](http://axkibe.github.io/lsyncd/manual/config/layer3/#all-possible-variables) |
| event.target | see ^target of [Layer 3](http://axkibe.github.io/lsyncd/manual/config/layer3/#all-possible-variables) |
| event.targetPath | see ^targetPath of [Layer 3](http://axkibe.github.io/lsyncd/manual/config/layer3/#all-possible-variables) |
| event.targetPathname | see ^targetPathname of [Layer 3](http://axkibe.github.io/lsyncd/manual/config/layer3/#all-possible-variables) |
